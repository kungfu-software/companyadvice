			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="headCount" title="${message(code: 'company.headCount.label', default: 'Head Count')}" />
					
						<g:sortableColumn property="latitidue" title="${message(code: 'company.latitidue.label', default: 'Latitidue')}" />
					
						<g:sortableColumn property="longtitude" title="${message(code: 'company.longtitude.label', default: 'Longtitude')}" />
				...
				<g:each in="${companyInstanceList}" status="i" var="companyInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: companyInstance, field: "headCount")}</td>
					
						<td>${fieldValue(bean: companyInstance, field: "latitidue")}</td>
					
						<td>${fieldValue(bean: companyInstance, field: "longtitude")}</td>
